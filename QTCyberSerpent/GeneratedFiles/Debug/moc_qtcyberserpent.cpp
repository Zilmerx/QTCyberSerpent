...
QT_MOC_LITERAL(4, 34, 11), // "CreateError"
QT_MOC_LITERAL(5, 46, 11), // "std::string"
QT_MOC_LITERAL(6, 58, 7) // "message"

    },
    "QTCyberSerpent\0UpdateImage\0\0image\0"
    "CreateError\0std::string\0message"
};
...
void QTCyberSerpent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->CreateError((*reinterpret_cast< const std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
